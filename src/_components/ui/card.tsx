...
export default function Card({ icon, title, desc, img, button, href, target }: CardProps) {
    return (
        <div className="card">
            ...
            <img src={img} />
            {href && button && (
                <a className="button-md" href={href} target={target}>
                    {button}
                </a>
            )}
        </div>
