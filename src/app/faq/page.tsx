    ...
    return (
        <div>
            ...
            <div className="CTA">
                ...
                <details>
                    <summary>How does Mythic run windows games on macOS</summary>
                ...
                <details>
                    <summary>How is this different from launchers like Heroic?</summary>
                ...
                <details>
                    <summary>Are you planning to add x launcher or x feature?</summary>
                ...
                <details>
                    <summary>What are the system requirements for Mythic?</summary>
                ...
                <details>
                    <summary>Is Mythic free?</summary>
